...
class ModalMountValidation {
	...
	@DisplayName("An open modal portals its backdrop and card into the overlay")
	@Test
	public rendersBackdrop() {
	...
	@DisplayName("The card sits inside an active, auto-sized ImageButton that swallows backdrop clicks")
	@Test
	public inputShield() {
		const host = new Instance("Folder");
	...
	@DisplayName("Percentage strings and UDim2 scale sizes both resolve to overlay-relative panel sizes")
	@Test
	public panelSizing() {
	...
	@DisplayName("Without the draggable prop the panel is centered and nothing is registered as draggable")
	@Test
	public defaultCentered() {
		const host = new Instance("Folder");
	...
	@DisplayName("A draggable modal turns its header into a drag handle and keeps the position where it was dropped")
	@Test
	public dragHandle() {
		const host = new Instance("Folder");
		latestRegistry = undefined;
	...
	@DisplayName("Activating a close button nested in a draggable header fires onOpenChange(false) without moving the panel")
	@Test
	...
	@DisplayName("An uncontrolled modal with defaultOpen renders its card on first mount")
	@Test
	public defaultOpen() {
		const host = new Instance("Folder");
	...
	@DisplayName("When both are supplied the controlled open prop wins over defaultOpen")
	@Test
	public controlledOpen() {
		const host = new Instance("Folder");
	...
	@DisplayName("Calling the close hook reports onOpenChange(false) but leaves a controlled modal mounted")
	@Test
	public closeHook() {
		const host = new Instance("Folder");
