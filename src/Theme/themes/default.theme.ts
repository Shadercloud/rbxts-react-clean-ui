...
export const DefaultTheme: ThemeTemplate = {
    ...
    components: {
        ...
        badge: {
            ...
            typography: {
                xs: { weight: Enum.FontWeight.Bold, size: Enum.FontSize.Size10 },
                sm: { weight: Enum.FontWeight.Bold, size: Enum.FontSize.Size12 },
                md: { weight: Enum.FontWeight.Bold, size: Enum.FontSize.Size14 },
                lg: { weight: Enum.FontWeight.Bold, size: Enum.FontSize.Size18 },
                xl: { weight: Enum.FontWeight.Bold, size: Enum.FontSize.Size24 },
            },
            intents: {
                primary: {
                    default: {
