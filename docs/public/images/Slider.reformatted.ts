...
type HighlightOption = "under" | "over" | "middle";
            ...
            >
                ...
                >
                    <uistroke
                        ...
                        Color={
                            theme.bar.borderColor
                        }
                    />

                    <uicorner
                        CornerRadius={SizeHelper.toUDim(
                            theme.bar
                                .cornerRadius,
                        )}
                    />
                    ...
                    {handles.map(
                        ({
                            ...
                            >
                                ...
                                {(this.state
                                    .hoveredHandle === index || (this.state.dragging && this.activeHandle === index)) && (
