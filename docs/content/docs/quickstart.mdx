...
```tsx title="/src/client/demo.client.tsx"
...
You can see examples under the [Stories](https://github.com/Shadercloud/rbxts-react-clean-ui/tree/master/Stories) directory on Github.
