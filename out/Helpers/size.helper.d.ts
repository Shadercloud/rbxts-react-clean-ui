...
export declare class SizeHelper {
    static GetSize(props: SizeElementProps): UDim2 | Binding<UDim2>;
    ...
    static GetAutoSize(props: SizeElementProps): Enum.AutomaticSize | "None" | "X" | "Y" | "XY" | Binding<Enum.AutomaticSize>;
