...
2. Read `docs/specifications/loom.md` — it is the authoritative spec for this directory. Also skim the "Stories and Loom demos" section of `AGENTS.md`.
