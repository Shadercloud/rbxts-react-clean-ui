            ...
            <Box>
                <Accordion defaultValue="overview" collapsible={props.controls.Collapsible} animationDuration={props.controls.Animation ? undefined : 0}>
                    <Accordion.Item value="overview">
                        ...
                        <Accordion.Content text="A short introduction to the accordion component." />
                    </Accordion.Item>
                    ...
                    <Accordion.Item value="disabled" disabled>
                        <Accordion.Header text="Unavailable section" />
                        <Accordion.Content text="This content cannot be opened." />
                    </Accordion.Item>
                </Accordion>
            </Box>
        </Container>
